...
fp = "../stats/cs_rm_2.csv"
fptxt = "../stats/cs_rm_2.txt"
fp_pic = "../stats/cs_rm_2.png"
...
# Optional: Plotting
plt.plot(df["Total_Tests"], df["Interesting_Commands"], label="Interesting Commands", marker='o', markersize=1)
plt.plot(df["Total_Tests"], df["Interesting_Passcodes"], label="Interesting Passcodes", marker='s', markersize=1)
